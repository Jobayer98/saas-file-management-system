...
export class FolderController {
  ...
  createFolder = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.createFolder(req.user!.id, req.body);
  ...
  getFolderById = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.getFolderById(req.user!.id, req.params.id as string);
  ...
  getChildrenFolders = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.getChildrenFolders(req.user!.id, req.params.id as string);
  ...
  updateFolder = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.updateFolder(req.user!.id, req.params.id as string, req.body);
  ...
  deleteFolder = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.deleteFolder(req.user!.id, req.params.id as string);
  ...
  moveFolder = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.moveFolder(req.user!.id, req.params.id as string, req.body);
  ...
  copyFolder = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.copyFolder(req.user!.id, req.params.id as string, req.body);
  ...
  getBreadcrumb = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.getBreadcrumb(req.user!.id, req.params.id as string);
  ...
  bulkCreateFolders = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.bulkCreateFolders(req.user!.id, req.body);
  ...
  bulkDeleteFolders = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.bulkDeleteFolders(req.user!.id, req.body);
  ...
  bulkMoveFolders = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await this.folderService.bulkMoveFolders(req.user!.id, req.body);
