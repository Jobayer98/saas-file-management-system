...
export class UserController {
  ...
  updateUserRole = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await userService.updateUserRole(req.params.id as string, req.body.isAdmin);
  ...
  suspendUser = asyncHandler(async (req: AuthRequest, res: Response) => {
    const result = await userService.suspendUser(req.params.id as string, req.body.reason);
