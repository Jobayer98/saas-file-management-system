...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "A comprehensive cloud-based file management platform built with modern web technologies, offering secure file storage, and sharing features with subscription-based access control.",
      contact: {
        name: "API Support",
